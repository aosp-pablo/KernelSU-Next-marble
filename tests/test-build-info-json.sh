...
zip_name=resukisu_susfs-marble-${today}.zip
zip_sha256=abc123
ENV
...
assert data["source"]["repo"] == "aosp-pablo/android_kernel_xiaomi_sm8450"
...
assert data["artifact"]["zip_name"].startswith("resukisu_susfs-marble-")
